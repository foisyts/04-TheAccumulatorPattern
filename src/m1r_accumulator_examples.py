...
#
#              for k in range(r - s):   needs s - r + 1
#                  count = 0        Should be before for loop
#                  if math.cos(r) > 0:      should be r + k
#                      count = 1        does not add onto the previous count
#                  return count     needs to be outside of the loop
#
#     f. The code in the "graphics accumulation" example below includes:
#            for _ in range(n):
#        What does the   _   (underscore) mean?
#               The loop variable is not planned to be used in the loop
