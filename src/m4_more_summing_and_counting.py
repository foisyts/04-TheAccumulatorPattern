...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 1
    answer = count_cosines_from(3, 5, 0.25)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 4
    answer = count_cosines_from(6, 9, -1)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 1
    answer = count_cosines_from(7, 9, 0)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.211307  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(77, 94)
